				...
				<div className="tweet-header">
					...
					<div className="tweet-content">
						...
						<div className="tweet-text">
							...
							<br />
							<br />
							Just acknowledge where you're retarded and either improve so
							you're no longer retarded, or don't act like you're not retarded.
						</div>
